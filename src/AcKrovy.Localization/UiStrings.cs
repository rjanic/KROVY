...
public static class UiStrings
{
    ...
    public static string CommandLabelsIntentionPrompt => GetString("Command_Labels_IntentionPrompt");
    public static string CommandLabelsKeywordMissingLocal => GetString("Command_Labels_KeywordMissingLocal");
    public static string CommandLabelsKeywordSelectLocal => GetString("Command_Labels_KeywordSelectLocal");
    public static string CommandLabelsKeywordAllLocal => GetString("Command_Labels_KeywordAllLocal");
    public static string CommandLabelsKeywordMissing => GetString("Command_Labels_KeywordMissing");
    public static string CommandLabelsKeywordSelect => GetString("Command_Labels_KeywordSelect");
    public static string CommandLabelsKeywordAll => GetString("Command_Labels_KeywordAll");
    public static string CommandLabelsResetAllTitle => GetString("Command_Labels_ResetAllTitle");
    public static string CommandLabelsResetAllWarning => GetString("Command_Labels_ResetAllWarning");
    public static string CommandLabelsCancelled => GetString("Command_Labels_Cancelled");
    public static string CommandLabelsNoOwnedSelection => GetString("Command_Labels_NoOwnedSelection");
    public static string CommandLabelsPromptSelectAnnotations => GetString("Command_Labels_PromptSelectAnnotations");
    ...
    public static string WarningLinetypeFallbackFormat => GetString("Warning_Linetype_FallbackFormat");
    public static string WarningExistingLayerPreservedFormat => GetString("Warning_ExistingLayerPreservedFormat");
    ...
    public static string DialogLayersConflictFormat => GetString("Dialog_Layers_ConflictFormat");
    public static string DialogLayersLinetypeScaleFormat => GetString("Dialog_Layers_LinetypeScaleFormat");
    ...
    public static string SettingsWindowLayersLinetypeColumn => GetString("SettingsWindow_Layers_LinetypeColumn");
    public static string SettingsWindowLayersLinetypeScaleColumn => GetString("SettingsWindow_Layers_LinetypeScaleColumn");
    ...
    public static string SettingsWindowApply => GetString("SettingsWindow_Apply");
    public static string SettingsWindowClose => GetString("SettingsWindow_Close");
    public static string SettingsWindowSettingsApplied => GetString("SettingsWindow_SettingsApplied");
    public static string SettingsWindowNoChanges => GetString("SettingsWindow_NoChanges");
    public static string SettingsWindowProfileSavedNewOnly => GetString("SettingsWindow_ProfileSavedNewOnly");
    public static string SettingsWindowDefaultsRestored => GetString("SettingsWindow_DefaultsRestored");
    public static string SettingsWindowLinetypeFallbackFormat => GetString("SettingsWindow_LinetypeFallbackFormat");
    public static string SettingsWindowSelectedElementsApplied => GetString("SettingsWindow_SelectedElementsApplied");
    public static string SettingsWindowSelectedElementsAlreadyMatch => GetString("SettingsWindow_SelectedElementsAlreadyMatch");
    public static string SettingsWindowNoSmartElementsSelected => GetString("SettingsWindow_NoSmartElementsSelected");
    public static string SettingsWindowSelectionCancelled => GetString("SettingsWindow_SelectionCancelled");
    public static string SettingsWindowAllElementsApplied => GetString("SettingsWindow_AllElementsApplied");
    public static string SettingsWindowAllElementsAlreadyMatch => GetString("SettingsWindow_AllElementsAlreadyMatch");
    public static string SettingsWindowExistingLayerInfoFormat => GetString("SettingsWindow_ExistingLayerInfoFormat");
    public static string SettingsWindowValidationFailed => GetString("SettingsWindow_ValidationFailed");
