...
internal sealed record PostFootprintPerpendicularAnnotationData
{
...
internal static class PostFootprintPerpendicularAnnotationStore
{
    ...
    public static bool TryRead(Entity entity, out PostFootprintPerpendicularAnnotationData? data)
    {
        data = null;
        ...
        using (xdata)
        {
            ...
            try
            {
                data = JsonSerializer.Deserialize<PostFootprintPerpendicularAnnotationData>(
                    json.ToString(),
                    JsonOptions);
