...
internal sealed record SlopeArrowData
{
...
internal static class SlopeArrowStore
{
    ...
    public static bool TryRead(Entity entity, out SlopeArrowData? data)
    {
        data = null;
        ...
        using (xdata)
        {
            ...
            try
            {
                data = JsonSerializer.Deserialize<SlopeArrowData>(json.ToString(), JsonOptions);
    ...
    public static void Write(Entity entity, Transaction transaction, SlopeArrowData data)
    {
